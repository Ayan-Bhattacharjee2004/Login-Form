...
public class LoginFormGui extends Form{
    ...
    public void addGuiComponents(){
        ...
        userenameTextField.setBackground(CommonConstants.SECONDERY_COLOR);
        ...
        passwordTextField.setBackground(CommonConstants.SECONDERY_COLOR);
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(MyJDBC.validateLogin(username, password)){
                    ...
                    // colose the courent box
                    LoginFormGui.this.dispose();

                    // Open a new frame or perform any other action for successful login
                    // Example: Open a new HomeFormGui
                    new HomeFormGui().setVisible(true);
                }else{
                    // login failed
